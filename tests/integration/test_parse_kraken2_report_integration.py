...
import sys
import unittest
from kraken2_scripts.parse_kraken2_report import Taxon, all_taxa_levels, check_args_print_tree, check_args_taxonomic_ranks, check_args_inhandle, read_kraken_report, parse_tree, add_parents_to_taxa, make_tree
...
class TestParseKraken2Report(unittest.TestCase):
    ...
    def test_read_kraken_report(self):
        kraken_report = read_kraken_report(self.inhandle, all_taxa_levels, None)
